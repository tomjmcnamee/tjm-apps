        ...
        <div className="row">
          <div className="col" id="SimulatorOptionsDiv">
            ...
            <form onSubmit={this.submitHandler}>
              ...
              <br />
              <h4>Above what RollSum number should the priority be flipping over a single tile?<input className="custom-range" type="range" name="higherThanThisNumber" min="2" max="12"  onChange={this.fieldChangeHandler} value={this.state.higherThanThisNumber}/> {this.state.higherThanThisNumber}</h4>
              <br />
